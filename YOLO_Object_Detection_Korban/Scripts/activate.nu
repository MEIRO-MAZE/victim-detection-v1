...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Kuliah\Robotika\KRSRI Software\KRSRI LOMBA\RISET\YOLO_Object_detection_korban'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Kuliah\Robotika\KRSRI Software\KRSRI LOMBA\RISET\YOLO_Object_detection_korban\Scripts\deactivate.nu'
